...
import { ficcao, livroFiccao } from '@/components/mockup/ficcao';
import Image from 'next/image';
import { useState } from 'react';

export default function ficcaoBC() {
    const [generoSelecionado, setGeneroSelecionado] = useState(7);

    const livrosFiltrados = ficcao.filter(livro =>
        livroFiccao.some(
    ...
    return (
        <div>
            {/* Título */}
            <h2 className={styles.titulo}>FICÇÃO</h2>
