      ...
      <div className={styles.resenhasContainer}>
        <div className={styles.resenhaBox}>
          ...
          <div className={styles.resenhaBotoes}>
            ...
            <button className={styles.btn}><p className={styles.btnTexto}>STATUS: APROVADO</p></button>
        ...
        <div className={styles.resenhaBox}>
          ...
          <div className={styles.resenhaBotoes}>
            <button className={styles.btn}><p className={styles.btnTexto}>ABRIR</p></button>
            <button className={styles.btn}><p className={styles.btnTexto}>STATUS: REPROVADO</p></button>
            <button className={styles.btn}><p className={styles.btnTexto}>ATUALIZAR</p></button>
          </div>
        </div>
        ...
        <div className={styles.resenhaBox}>
          ...
          <div className={styles.resenhaBotoes}>
            <button className={styles.btn}><p className={styles.btnTexto}>ABRIR</p></button>
            <button className={styles.btn}><p className={styles.btnTexto}>STATUS: CORREÇÃO</p></button>
            <button className={styles.btn}><p className={styles.btnTexto}>ATUALIZAR</p></button>
          </div>
        </div>
      </div>
